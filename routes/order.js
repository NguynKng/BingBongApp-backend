...
const { createOrder, getUserOrders, getShopOrders, getOrderById, updateOrderStatus, cancelOrder, receiveOrder } = require("../controllers/order");
...
router.post("/user-receive", protect, receiveOrder);
